...
//    int myRefCount;
    ...
    id myWeightEvents;	/* this means myWeight list */ // pairs of form (Event,Gewicht)
    spaceIndex mySpace;					// defines with bit vektor the subset of EHLDGC
    ...
    double myStartNorm;
    double myRange;
    double myTolerance;  // width of margin of the field. outside of the margin:1
