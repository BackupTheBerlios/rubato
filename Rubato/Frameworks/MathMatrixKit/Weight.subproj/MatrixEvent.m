...
- copyWithZone:(NSZone*)zone;
{
    ...
    myCopy->mySatellites = [mySatellites mutableCopyWithZone:zone]; //jgrelease without ref?
    return myCopy;
}
...
- (selfvoid)setToMatrix:aMatrix;
{
	...
	[self setSatellites:[[aMatrix satellites] jgCopyWithZone:[self zone]]]; // jgrelease
    }
...
// jg compareTo is inherited from MathMatrix.
